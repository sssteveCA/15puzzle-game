...
class Giocatore{
    ...
    private $database; //database MySql dove è contenuta la tabella
    private $tabella; //tabella MySql degli utenti registrati
    private $id;
    private $username; 
    private $email;
    private $password;
    private $sequenza; //ordine attuale dei numeri dentro la tessera
    private $tempo; //(se il gioco è stato salvato)tempo impiegato prima di salvare il gioco
    private $spostamenti; //(se il gioco è stato salvato)numero di spostamenti delle tessere prima di salvare il gioco
    ...
    public function __construct($dati){
        ...
        $this->sequenza = null;
        $this->tempo = isset($dati['tempo'])? $dati['tempo']:null;
        $this->spostamenti = isset($dati['spostamenti'])? $dati['spostamenti']:null;
...
SQL;
    ...
    public function valida(){
        ...
        if(isset($this->tempo)){
            if(!preg_match(Giocatore::$regex['tempo'],$this->tempo))$ok = false;
        }
        return $ok;
    }
